...
export class NewMigration1725127256846 implements MigrationInterface {
    name = 'NewMigration1725127256846'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`connected_user\` ADD CONSTRAINT \`FK_509f0623b39c0c278ea0c063f35\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`connected_user\` DROP FOREIGN KEY \`FK_509f0623b39c0c278ea0c063f35\``);
